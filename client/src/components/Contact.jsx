...
//           className="bg-white dark:bg-gray-900 shadow-lg rounded-xl p-8 flex flex-col gap-6"
//         >
//           <input
//             type="text"
//             name="name"
...
//             className="p-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
//             required
//           />
//           <input
//             type="email"
...
//             onChange={handleChange}
//             rows={5}
//             className="p-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
//             required
//           ></textarea>
...
//         <div className="mt-10 text-center space-x-6 text-gray-600 dark:text-gray-400 text-xl">
//           <a
...
//           </a>
//           <a
//             href="https://linkedin.com/in/thirisala"
//             target="_blank"
//             rel="noopener noreferrer"

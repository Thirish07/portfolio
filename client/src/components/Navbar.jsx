...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0.2  w-screen bg-white dark:bg-gray-900 shadow-md z-50">
      {/* Container */}
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => setMenuOpen(!menuOpen)}
            className="md:hidden p-2 rounded-md bg-gray-200 dark:bg-gray-700 hover:scale-110 transition-transform duration-200 flex items-center justify-center"
          >
            {menuOpen ? (
              <XMarkIcon className="w-6 h-6 text-gray-800 dark:text-white" />
            ) : (
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 shadow-md flex flex-col items-center space-y-4 py-4">
          <a onClick={() => setMenuOpen(false)} href="#home" className="hover:text-blue-500">Home</a>
          <a onClick={() => setMenuOpen(false)} href="#about" className="hover:text-blue-500">About</a>
          <a onClick={() => setMenuOpen(false)} href="#education" className="hover:text-blue-500">Education</a>
          <a onClick={() => setMenuOpen(false)} href="#internship" className="hover:text-blue-500">Internships</a>

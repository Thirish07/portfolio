...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden min-h-[85vh] flex flex-col-reverse md:flex-row items-center justify-center gap-8 px-4 sm:px-8 md:px-12 pt-6"
    >
      {/* 🔵 Background Blob Top Left */}
      ...
      <div className="relative z-10 w-full flex flex-col-reverse md:flex-row items-center justify-center gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-xl">
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-snug text-gray-800 dark:text-white text-center md:text-left"
          >
            Hi, I'm{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-text-shimmer">
              Thirisala G
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 0.8 }}
            className="mt-4 text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-md text-center md:text-left"
          >
            Fresh perspective, real-world skills.
          </motion.p>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.5, duration: 0.8 }}
          className="w-full max-w-[300px] sm:max-w-[350px] md:max-w-[400px] h-[250px] sm:h-[350px] md:h-[400px]"
        >
          <SkillSphere />
        </motion.div>
      </div>
